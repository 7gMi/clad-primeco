...
export function getCompanyNotificationEmail(data: ContactData): string {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <div class="cta">
        <a href="mailto:${data.email}?subject=Re: Your enquiry to Clad-Primeco">Reply to ${data.name}</a>
      </div>
      <div class="divider"></div>
      <p class="meta">Received: ${data.submittedAt}</p>
    </div>
    <div class="footer">
      <p>Clad-Primeco Ltd &nbsp;|&nbsp; Cork, Ireland<br />This email was generated automatically from the contact form on cladprimeco.ie</p>
    </div>
  </div>
</body>
</html>`
...
<head>
  ...
  <style>
    ...
    .divider { height: 1px; background-color: #e2e8f0; margin: 28px 0; }
    .contact-row { display: flex; gap: 12px; margin-bottom: 10px; align-items: flex-start; }
    .contact-label { font-size: 12px; font-weight: 600; color: #64748b; min-width: 60px; text-transform: uppercase; letter-spacing: 0.5px; padding-top: 1px; }
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p>We aim to respond to all enquiries within <strong>2–3 business days</strong>. If your matter is urgent, please don't hesitate to call us directly.</p>
      <div class="info-box">
        ...
        <p>If you have additional information to share in the meantime, simply reply to this email and it will be added to your enquiry.</p>
      </div>
      <div class="divider"></div>
      <p style="font-size:13px;font-weight:600;color:#64748b;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:16px;">Contact Information</p>
      <div class="contact-row">
        <span class="contact-label">Address</span>
        <span class="contact-value">Cork, Ireland</span>
      </div>
      <div class="contact-row">
        <span class="contact-label">Email</span>
        <span class="contact-value"><a href="mailto:info@cladprimeco.ie">info@cladprimeco.ie</a></span>
      </div>
      <div class="contact-row">
        <span class="contact-label">Web</span>
        <span class="contact-value"><a href="https://cladprimeco.ie">cladprimeco.ie</a></span>
      </div>
    </div>
    <div class="footer">
      <p>Clad-Primeco Ltd &nbsp;|&nbsp; Cork, Ireland<br />You are receiving this email because you submitted a contact form on cladprimeco.ie</p>
    </div>
  </div>
</body>
</html>`
