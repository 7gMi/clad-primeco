...
export default function HeroCard({ tagline, title, subtitle, onNavigate }: HeroCardProps) {
  return (
    <div className="hero-card max-w-4xl mx-auto md:mx-0 text-center md:text-left">
      ...
      <h2 className="text-gray-200 text-base md:text-lg lg:text-xl mb-8 md:mb-10 leading-relaxed max-w-3xl mx-auto md:mx-0">
        {subtitle}
      </h2>
