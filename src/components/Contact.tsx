...
export default function Contact() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
      setError(
        'Service configuration error. Please contact us directly at cladprimeco@outlook.com.',
      );
      submittingRef.current = false;
      return;
    }
    ...
    try {
      ...
      setSuccess(
        'Message received. A member of our team will come back to you within 24 hours — usually sooner.',
      );
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-slate-700 leading-relaxed mb-10">
                  Got a project coming up? Send us your brief or drawings and we will come back with
                  a detailed, competitive quote. No sales process — just straight answers from the
                ...
                <div className="space-y-5">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-base sm:text-xl font-bold text-slate-900 group-hover:text-blue-600 transition-colors break-all">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              <div>
                ...
                <p className="text-lg text-slate-700 leading-relaxed mb-10">
                  Whether you need a quote, have a technical question, or want to discuss an
                  upcoming project — our team is ready to help. Fill in the form and we'll get back
                  to you promptly.
                </p>
                  ...
                  <div className="flex gap-5 py-5 border-b border-slate-200">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 mb-1">
                        Precise quotes, fast turnaround
                      </p>
                      <p className="text-slate-500 text-sm leading-relaxed">
                        We review your requirements and respond with accurate, itemised pricing — no
                        ballpark figures, no back-and-forth.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-5 py-5 border-b border-slate-200">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 mb-1">
                        Direct line to the decision-makers
                      </p>
                      <p className="text-slate-500 text-sm leading-relaxed">
                        No intermediaries. You deal directly with the team responsible for
                        delivering your project — from quote to completion.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-5 py-5 border-b border-slate-200">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 mb-1">
                        Ireland-wide delivery capacity
                      </p>
                      <p className="text-slate-500 text-sm leading-relaxed">
                        Dublin-based, nationwide reach. We have completed projects from Cork to
                        Wexford to Limerick — and everywhere in between.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="Aluminium Copings & Roof Deck">
                  ...
                  <div className="flex flex-col gap-3">
                    {HCAPTCHA_SITEKEY ? (
                      ...
                      <p className="text-red-500 text-sm">
                        Captcha configuration error. Please contact us directly at
                        cladprimeco@outlook.com.
                      </p>
                    )}
                    <p className="text-xs text-slate-400 leading-relaxed">
                      ...
                      . Your data is used solely to respond to your enquiry and is never shared with
                      third parties.
                    </p>
                  </div>
