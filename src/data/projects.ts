...
export const projects: Project[] = [
  {
    ...
    year: 2024,
    description:
      "Full building envelope package for Amazon's Dublin 104 logistics facility — one of the largest contracts in our portfolio. Works included 5,000 m² of architectural panels and Kingspan insulated panels, complete with window cills, door flashings and aluminium copings, delivered over 7 months to meet Amazon's demanding programme and quality standards.",
    specifications: {
      surface: '5,000 m²',
  ...
  },
  {
    ...
    year: 2025,
    description:
      "Cladding package for Vantage's power station facility in Dublin city centre. Works covered 2,400 m² of Kingspan RW panels complete with copings, door flashings and window cills — installed to the exacting standards required for critical energy infrastructure, completed in 3 months.",
    specifications: {
      surface: '2,400 m²',
  ...
  },
  {
    ...
    year: 2023,
    description:
      'Kingspan cladding installation for the new Carrigtwohil College building in Cork. The 3,000 m² package included Kingspan insulated panels, door flashings and window cills — delivering thermal performance and a clean architectural finish for this new educational facility.',
    specifications: {
      surface: '3,000 m²',
  ...
  },
  {
    ...
    year: 2025,
    description:
      "Cladding upgrade for Bausch & Lomb's pharmaceutical manufacturing facility in Waterford. The 3,000 m² programme of Kingspan architectural panels was carried out within an active facility, maintaining strict safety and quality protocols throughout the 4-month contract.",
    specifications: {
      surface: '3,000 m²',
  ...
  },
  {
    ...
    year: 2026,
    description:
      "Roof and facade cladding for ABP's food processing facility in Rathkeale. The 1,600 m² contract covered Kingspan roof panels combined with aluminium RW facade cladding — delivered in just 3 months to keep the facility's expansion programme on schedule.",
    specifications: {
      surface: '1,600 m²',
  ...
  },
  {
    ...
    year: 2025,
    description:
      "Roofing and cladding works at Rosslare Europort, one of Ireland's busiest ferry terminals. The contract covered 2,400 m² of standing seam roofing and cladding with door flashings and window cills — executed over 3 months within an active port environment requiring strict coordination with port operations.",
    specifications: {
      surface: '2,400 m²',
  ...
  },
  {
    ...
    year: 2024,
    description:
      "Facade cladding package for the Lily Superstore in Limerick. The 4,000 m² contract included external cladding panels, aluminium copings, window cills and door flashings — delivered over 4 months to a tight retail programme, achieving a high-quality finish that enhances the building's commercial identity.",
    specifications: {
      surface: '4,000 m²',
  ...
  },
  {
    ...
    year: 2024,
    description:
      'Fast-track Kingspan cladding installation for a warehouse and depot facility in Sandyford Business District, Dublin. The 1,700 m² package was completed in just 2 months, demonstrating our ability to deliver quality works to compressed programmes for commercial clients.',
    specifications: {
      surface: '1,700 m²',
